      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-0">
          {STATS.map((stat, i) => (
            <motion.div
              key={stat.label}
              className={`flex flex-col items-center py-10 text-center relative ${
                i < STATS.length - 1
            ...
            >
              <div className="font-display text-5xl md:text-6xl lg:text-7xl font-black gradient-text-purple leading-none mb-3">
                <AnimatedCounter
                  target={stat.value}
                  suffix={stat.suffix}
                  duration={2500}
              ...
              <p className="text-sm text-offwhite/40 font-body tracking-[0.15em] uppercase">
                {stat.label}
              </p>
            </motion.div>
          ))}
